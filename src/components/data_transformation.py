...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            preprodessor=ColumnTransformer([
            ...
            logging.info('Plipeline Completed')
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("Applying preprocessing object on training and testing datasets datasets")
            ...
            logging.info('Processor Pickle file in created and saved')
